...
{
$sql = mysqli_query($con,"SELECT * FROM  tbl_student where student_registration_no = '".$_SESSION['login']."'");
$num = mysqli_fetch_array($sql);

$password_check = password_verify(mysqli_real_escape_string($con, $_POST["password"]), $num["password"]);
if($password_check)
{ 
  $newpassword = mysqli_real_escape_string($con, $_POST["newpassword"]);
  $password_hash = password_hash($newpassword, PASSWORD_DEFAULT);
 $con = mysqli_query($con,"UPDATE tbl_student SET password = '$password_hash', updationDate='$currentTime' where student_registration_no = '".$_SESSION['login']."'");
