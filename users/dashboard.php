...
{?>
					  			...
					  			<p style="color: #b00000;"><?php echo htmlentities($num1);?> Complaints not Process yet</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p style="color: #2b2703;"><?php echo htmlentities($num1);?> Complaints Status in process</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p style="color: green;"><?php echo htmlentities($num1);?> Complaint has been closed</p>
                      </div>
