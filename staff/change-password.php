...
{
$sql = mysqli_query($con,"SELECT * FROM  staff where  username='".$_SESSION['alogin']."'");
...
$hash_password = password_hash($newpassword, PASSWORD_DEFAULT);
 $con = mysqli_query($con,"UPDATE staff SET password = '$hash_password', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
