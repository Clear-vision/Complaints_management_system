...
<head>
	...
	<title>staff | Not Process Complaints</title>
...
tbl_student.fullName AS name FROM tblcomplaints 
JOIN tbl_student ON tbl_student.id=tblcomplaints.userId 
WHERE  tblcomplaints.department = '".$_SESSION['department']."' 
AND  tblcomplaints.status is NULL ");
...
?>										
										<tr>
											...
											<td><?php echo htmlentities(date('F d, Y - h:i:s A',strtotime($row['regDate'])));?></td>
