...
$sql = mysqli_query($con,"INSERT INTO program(program_name,faculty_id) VALUES('$program','$faculty')");
$_SESSION['msg'] = "Program Created";

}

if(isset($_GET['del']))
		  {
		          mysqli_query($con,"DELETE FROM  program WHERE  id = '".$_GET['id']."'");
...
<?php $query = mysqli_query($con,"SELECT * FROM faculty");
...
<div class="controls">
<input type="text" placeholder="Enter Program Name"  name="program" class="span8 tip" required>
</div>
</div>
...
<?php $query = mysqli_query($con,"SELECT program.id, 
	                         faculty.facultyName, 
	                         program.program_name, 
	                         program.creationDate,
	                         program.updationDate 
	                         from program join faculty 
...
?>									
										<tr>
											...
											<td>
											<a href="edit-program.php?id=<?php echo $row['id']?>" ><i class="icon-edit"></i></a>
											<a href="program.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $section = $section + 1; } ?>
