...
<tbody>
<?php 
$query = mysqli_query($con, "SELECT tblcomplaints.*, tbl_student.fullName AS name FROM tblcomplaints JOIN tbl_student ON tbl_student.id=tblcomplaints.userId WHERE tblcomplaints.status is NULL ");
