...
$sql = mysqli_query($con,"INSERT INTO department(department_name,faculty_id) values('$department','$faculty')");
...
<div class="controls">
<select name="faculty">
	<option>Select faculty (if availabe)</option>
	<?php
